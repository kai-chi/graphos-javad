...
void OMAP::deleteNode(Bid omapKey) {
    ...
    if (rootKey == 0) {
        rootKey = treeHandler->deleteNode3(0, rootPos, rootKey, parentPos, 0, omapKey, height, 0, children, depth, true, false);
    } else {
        rootKey = treeHandler->deleteNode3(rootKey, rootPos, rootKey, parentPos, 0, omapKey, height, 0, children, depth, true, false);
    }
//    if (treeHandler->logTime) {
