...
our %config = (
    ...
    "CFLAGS" => [
        "-Wall -O3",
        "-g",
        "-include/data/kajetan/repo/graphos-javad/Omix++/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h"
    ],
    "CPPDEFINES" => [
        "_FORTIFY_SOURCE=2",
...
unless (caller) {
    ...
    use lib '/data/kajetan/repo/graphos-javad/Omix++/sgxssl/openssl_source/openssl-3.0.10/util/perl';
    use OpenSSL::fallback '/data/kajetan/repo/graphos-javad/Omix++/sgxssl/openssl_source/openssl-3.0.10/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/data/kajetan/repo/graphos-javad/Omix++/sgxssl/openssl_source/openssl-3.0.10/Configurations';
        use gentemplate;
